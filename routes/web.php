...
Route::middleware(['auth'])->group(function () {
    ...
    Route::middleware(['admin_auth'])->group(function () {
        ...
        Route::prefix('order')->group(function () {
            ...
            Route::get('listInto/{orderCode}', [OrderController::class, 'listInfo'])->name('admin#listInfo');
        });
        ...
        // contact
        Route::get('contact/list',[UserController::class,'contactList'])->name('admin#contactList');
    });
